...
import { listAssignedStudents } from '../../api/manager'
...
export function ManagerStudentsPage() {
  ...
  if (loading) return <Spinner label="Loading assigned students..." />
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Students assigned to you for management
        </p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <StatCard icon={Users} label="Total Assigned" value={students.length} />
